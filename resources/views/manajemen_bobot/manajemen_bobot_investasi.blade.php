        ...
        <div class='row'>
            <div class='col-md-12'>
                    <div class="box-header with-border">
                      <h4 class="box-title">Form Manajemen Bobot Kriteria Investasi (Level 2)</h4><br>
                    </div>
                    <div class="box-body">
                        <form method="post" enctype="multipart/form-data" action="/update_bobot_kriteria_investasi/simpan">
                            {{ csrf_field() }}
